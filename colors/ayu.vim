...
let s:palette.comment   = {'dark': "#B6B7B9",  'light': "#ABB0B6",  'mirage': "#B6B7B9"}
...
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#B6B7B9"}
let s:palette.selection = {'dark': "#253340",  'light': "#F0EEE4",  'mirage': "#343F4C"}
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#B6B7B9",  'mirage': "#D9D7CE"}

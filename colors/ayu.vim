...
let s:palette.comment   = {'dark': "#A7A8AA",  'light': "#ABB0B6",  'mirage': "#A7A8AA"}
...
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#ff0000"}
let s:palette.selection = {'dark': "#253340",  'light': "#F0EEE4",  'mirage': "#343F4C"}
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#A7A8AA",  'mirage': "#D9D7CE"}

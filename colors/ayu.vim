...
let s:palette.comment   = {'dark': "#A7B2C8",  'light': "#ABB0B6",  'mirage': "#A7B2C8"}
...
let s:palette.panel     = {'dark': "#14191F",  'light': "#FFFFFF",  'mirage': "#ff0000"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#00ff00"}
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#A7B2C8"}
